...
public interface ScheduleControllerDocs {
    ...
    ResponseEntity<?> vote(Long id, Long idUser) throws UserNotFoundException, ScheduledNotFoundException, VotacaoFinalizadaException, NamingException;
    ...
    ResponseEntity<?> openSchedule(Long id) throws ScheduledNotFoundException, VotacaoFinalizadaException, NamingException;
